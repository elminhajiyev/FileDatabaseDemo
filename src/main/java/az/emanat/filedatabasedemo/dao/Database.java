...
public interface Database {
     ...
     */
    void update(String tableName, int rowId, List<String> values) throws NotFoundException;
     ...
     * @throws NotFoundException if the table / row ID combination did not match an existing row
     */
    List<String> select(String tableName, int rowId) throws NotFoundException;
}
